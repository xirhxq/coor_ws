...
: ${AMENT_CURRENT_PREFIX:="/home/bit/coor_ws/install/search"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/search/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/search/environment/path.sh"
